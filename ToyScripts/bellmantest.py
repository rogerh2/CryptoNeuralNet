        ...
        for i in range(offset, data_len):
            ...
            if save_inds:
                ...
                if (ind%121 == 0) & (fin_table is not None):
                    ...
                    self.prediction[ind::] = prediction[(ind-31)::, 0]
...
if __name__ == '__main__':
    ...
    pickle_path = '/Users/rjh2nd/PycharmProjects/CryptoNeuralNet/Models/DataSets/CryptoPredictDataSet_minutes_from_2018-06-15_10:20:00_EST_to_2018-08-30_21:52:00_EST.pickle'
    ...
    date_to = '2018-08-30 21:52:00 EST'
    bitinfo_list = ['eth']
    ...
    strategy_obj = OptimalTradeStrategyV2(prediction[start_ind::, 0], test_output[start_ind:-30, 0])
