...
class DataSet:
    ...
    def create_buy_sell_prediction_frame(self, m):
        ...
        sell_list, buy_list = find_optimal_trade_strategy(price_data_frame.values)
        sell_column = np.array(sell_list).reshape(len(buy_list), 1)
        buy_column = np.array(buy_list).reshape(len(buy_list), 1)
...
if __name__ == '__main__':
    ...
    if code_block == 1:
        ...
        #date_from = '2018-09-23 21:46:00 EST'
        ...
        model_path = '/Users/rjh2nd/PycharmProjects/CryptoNeuralNet/Models/Models/3_Layers/Current_Best_Model/ETHmodel_30minutes_leakyreluact_adamopt_mean_absolute_percentage_errorloss_37neurons_4epochs1537574552.272846.h5'
        ...
        pickle_path = '/Users/rjh2nd/PycharmProjects/CryptoNeuralNet/Models/DataSets/CryptoPredictDataSet_minutes_from_2018-06-15_10:20:00_EST_to_2018-09-23_21:46:00_EST.pickle'
